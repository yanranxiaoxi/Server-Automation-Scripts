...
dnf makecache
dnf update -y
dnf install -y glibc-common langpacks-zh_CN dnf-automatic kpatch kpatch-dnf passwd wget net-tools firewalld fail2ban git cockpit cockpit-packagekit cockpit-storaged cockpit-podman netavark
